...
<body>
  ...
  <div class="aux">
    ...
    <button type="button" id="btnSideChatLayoutSettings" title="Open Settings for where new side-chat panels open (beside vs active column)">Side chat opens…</button>
