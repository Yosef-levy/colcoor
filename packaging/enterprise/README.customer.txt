...
---------------------------
  ...
  Note: the Compose file uses a fixed named volume (colcoor_postgres_data). Run at most one
  Colcoor stack per Docker host unless you change the volume name in docker-compose.yml.
